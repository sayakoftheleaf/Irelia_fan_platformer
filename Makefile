...
IreliaFanGame-Linux-Debug:
	 $(PROJECTBUILD) IreliaFanGame Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGame-Linux-DebugGame:
	 $(PROJECTBUILD) IreliaFanGame Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGame-Linux-Shipping:
	 $(PROJECTBUILD) IreliaFanGame Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGame-Linux-Test:
	 $(PROJECTBUILD) IreliaFanGame Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGame:
	 $(PROJECTBUILD) IreliaFanGame Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGameEditor-Linux-Debug:
	 $(PROJECTBUILD) IreliaFanGameEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGameEditor-Linux-DebugGame:
	 $(PROJECTBUILD) IreliaFanGameEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGameEditor-Linux-Shipping:
	 $(PROJECTBUILD) IreliaFanGameEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGameEditor-Linux-Test:
	 $(PROJECTBUILD) IreliaFanGameEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

IreliaFanGameEditor:
	 $(PROJECTBUILD) IreliaFanGameEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
