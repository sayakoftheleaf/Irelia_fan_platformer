...
IreliaFanGameRootPath=/home/sayak/Coding/Unreal Projects/IreliaFanGame

gameProjectFile=/home/sayak/Coding/Unreal Projects/IreliaFanGame/IreliaFanGame.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(IreliaFanGameSource.pri)
include(IreliaFanGameHeader.pri)
include(IreliaFanGameConfig.pri)
include(IreliaFanGameIncludes.pri)
include(IreliaFanGameDefines.pri)

IreliaFanGame-Linux-Debug.commands = $$build IreliaFanGame Linux Debug  -project="\"$$gameProjectFile\"" $$args
IreliaFanGame-Linux-DebugGame.commands = $$build IreliaFanGame Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
IreliaFanGame-Linux-Shipping.commands = $$build IreliaFanGame Linux Shipping  -project="\"$$gameProjectFile\"" $$args
IreliaFanGame-Linux-Test.commands = $$build IreliaFanGame Linux Test  -project="\"$$gameProjectFile\"" $$args
IreliaFanGame.commands = $$build IreliaFanGame Linux Development  -project="\"$$gameProjectFile\"" $$args

IreliaFanGameEditor-Linux-Debug.commands = $$build IreliaFanGameEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
IreliaFanGameEditor-Linux-DebugGame.commands = $$build IreliaFanGameEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
IreliaFanGameEditor-Linux-Shipping.commands = $$build IreliaFanGameEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
IreliaFanGameEditor-Linux-Test.commands = $$build IreliaFanGameEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
IreliaFanGameEditor.commands = $$build IreliaFanGameEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	IreliaFanGame-Linux-Debug \
	IreliaFanGame-Linux-DebugGame \
	IreliaFanGame-Linux-Shipping \
	IreliaFanGame-Linux-Test \
	IreliaFanGame \
	IreliaFanGameEditor-Linux-Debug \
	IreliaFanGameEditor-Linux-DebugGame \
	IreliaFanGameEditor-Linux-Shipping \
	IreliaFanGameEditor-Linux-Test \
	IreliaFanGameEditor \
